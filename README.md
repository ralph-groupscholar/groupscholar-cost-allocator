...
- Reporting views for cohort monthly totals, cost center rollups, allocation gaps, rule coverage, cost center allocation balance, and unallocated items.
...
- `groupscholar_cost_allocator.v_center_allocation_balance`
